...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            "Membuat preview aplikasi/landing page HTML/CSS/JS via GitHub (branch terpisah, bisa dihapus bersih) "
            "dan mengembalikan link preview yang bisa dibuka publik. "
            "Gunakan saat pengguna meminta dibuatkan landing page, website, aplikasi web (to do list, kalkulator, dll), atau meminta preview tampilan."
        ),
        "parameters": {
            "type": "object",
            "properties": {
...
async def preview_with_codepen(
    ...
    """
    Membuat preview aplikasi/landing page HTML/CSS/JS via GitHub branch terpisah
    dan mengembalikan URL preview yang bisa dibuka publik (htmlpreview).
    ...
    # Engine preview: GitHub Preview (branch terpisah, bisa dihapus bersih).
    # JSFiddle & CodePen dihapus karena tidak lagi mengembalikan link preview yang valid/terbuka.
    ...
    return {
        "status": "error",
        "result_code": "ERROR",
        "error": f"ERROR: Gagal membuat link preview GitHub. Detail: {gh.get('error', '')}",
        "url": None,
    }
